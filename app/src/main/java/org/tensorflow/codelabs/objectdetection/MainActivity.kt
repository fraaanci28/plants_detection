...
class MainActivity : AppCompatActivity(), View.OnClickListener {
     ...
     *      Ejecuta la detección de objetos utilizando el modelo TFLite y dibuja los resultados.
     *      Convierte el bitmap a un objeto TensorImage, corre el modelo de detección y dibuja las cajas de los objetos detectados en la imagen.
     */
